...
import { CreateAssignmentComment } from './CreateAssignmentComment'
import { MarkDownDiv } from '@/components/utils/MarkDownDiv'
import { ShowAssignmentEvent } from './ShowAssignmentEvent'
import { CreateAssignmentTurnIn } from './CreateAssignmentTurnIn'
import { GradeAssignment } from './GradeAssignment'

export const StudentAssignment = ({ profile, id }) => {
          ...
          <div className="card">
            <div className="card-content">
              ...
              <div className="content">
                <MarkDownDiv markdown={assignment.homework.body_with_resolved_urls} />
              </div>
            </div>
          </div>
        </div>
